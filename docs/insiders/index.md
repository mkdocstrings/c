...
*mkdocstrings-c* follows the **sponsorware** release strategy, which means
...
*mkdocstrings-c Insiders* is a private fork of *mkdocstrings-c*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *mkdocstrings-c*.
...
*mkdocstrings-c* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *mkdocstrings-c*,
...
<small>
  ...
  your profile and avatar to show your support for *mkdocstrings-c*.
...
to use *mkdocstrings-c* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *mkdocstrings-c*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *mkdocstrings-c
Insiders* precisely under the same terms as *mkdocstrings-c*, which are given
